    ...
    <div class="container">
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <p class="card-text">Our project yielded several interesting findings. Our inner OKC superfans were validated, 
                    as in both techniques, we saw that our Thunder placed top 2 in successful pick percentage (SPP). 
                    In fact, we were happy to see that the top 5 teams by SPP computed using each of our methods respectively were composed of 
                    nearly the exact same teams. By having two measures of SPP that both yielded nearly the same results, 
                    we were able to confirm that there did not seem to be too much variability in the results, strengthening each individual finding. 
                    We hope to look upon our SPP graphs leading up to each annual NBA Draft as we use our custom tool to make informed predictions on the success of future NBA Draft picks.</p>
            </div>
        </div>

        <!-- Footer -->
        <footer class="footer">
            Pushpesh Thakur and Atai Tahasan
        </footer>
    </div>
</body>
</html>
